...
Video games have been regarded as a major source of entertainment for countless of people. However, it has proven difficult for individuals with impairments to enjoy and actually play their games. As a result, this paper will analyse and address the various methods that can be implemented in action games to accomodate for hearing impaired gamers, both to improve their experience and generally provide more accessibility for a wider range of players. This will be done with aid from previous research and by discussing potential alternatives, as well as how they can be implemented.
