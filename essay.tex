...
% translation tool allows software to be released in different countires quicker, whereas games it will take time, if they want it done properly, text boxes and display code will ahve to be rewritten for countries that read right to left
